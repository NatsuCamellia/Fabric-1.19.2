...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_TANZANITE_ORE =
            ConfiguredFeatures.register("nether_tanzanite_ore", Feature.ORE, new OreFeatureConfig(NETHER_TANZANITE_ORES, 11));
    ...
    public static void registerConfiguredFeatures() {
        Tanzanite.LOGGER.debug("Registering Configured Features for " + Tanzanite.MOD_ID);
    }
}
