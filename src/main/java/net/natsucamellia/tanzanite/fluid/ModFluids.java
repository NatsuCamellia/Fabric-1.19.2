package net.natsucamellia.tanzanite.fluid;
...
public class ModFluids {
    ...
    public static void register() {
        STILL_SOAP_WATER = Registry.register(Registry.FLUID,
                new Identifier(Tanzanite.MOD_ID, "soap_water"), new SoapWaterFluid.Still());
        FLOWING_SOAP_WATER = Registry.register(Registry.FLUID,
                new Identifier(Tanzanite.MOD_ID, "flowing_soap_water"), new SoapWaterFluid.Flowing());

        SOAP_WATER_BLOCK = Registry.register(Registry.BLOCK, new Identifier(Tanzanite.MOD_ID, "soap_water_block"),
                new FluidBlock(ModFluids.STILL_SOAP_WATER, FabricBlockSettings.copyOf(Blocks.WATER)));
        SOAP_WATER_BUCKET = Registry.register(Registry.ITEM, new Identifier(Tanzanite.MOD_ID, "soap_water_bucket"),
                new BucketItem(ModFluids.STILL_SOAP_WATER, new FabricItemSettings().group(ModItemGroup.TANZANITE)
